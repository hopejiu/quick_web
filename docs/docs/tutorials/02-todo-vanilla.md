...
For production apps, you'd typically add database persistence. See the [Database Integration](https://v3.wails.io/guides/patterns/database) guide for examples with SQLite, PostgreSQL, etc.
...
- **Add persistence:** Make todos survive app restarts with [SQLite](https://v3.wails.io/guides/patterns/database)
- **Add more features:** Filtering (all/active/completed), editing existing todos, bulk operations
- **Explore the Notes tutorial:** See how file operations work in [Notes](https://v3.wails.io/tutorials/03-notes-vanilla)
