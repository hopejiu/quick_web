...
- **Custom Events** - Create your own event types
  [Learn More →](https://v3.wails.io/features/events/custom)
- **Event Patterns** - Common event patterns and best practices
  [Learn More →](https://v3.wails.io/features/events/patterns)
- **Bindings** - Use bindings for request/response
