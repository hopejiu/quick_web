...
**For more menu item types**, see [Menu Reference](https://v3.wails.io/features/menus/reference).
...
> **Always Call menu.Update():** After changing menu state (enable/disable, label, checked), **always call `menu.Update()`**. This is especially critical on Windows where menus are reconstructed.
...
func toggleDarkMode(ctx *application.Context) { /* Implementation */ }
func openDocumentation(ctx *application.Context) { /* Implementation */ }
func showAbout(ctx *application.Context) { /* Implementation */ }
```
...
- **Menu Reference** - Complete reference for menu item types and properties
  [Learn More →](https://v3.wails.io/features/menus/reference)
- **Context Menus** - Create right-click context menus
  [Learn More →](https://v3.wails.io/features/menus/context)
- **System Tray Menus** - Add system tray/menu bar integration
  [Learn More →](https://v3.wails.io/features/menus/systray)
- **Menu Patterns** - Common menu patterns and best practices
  [Learn More →](https://v3.wails.io/guides/patterns/menus)
