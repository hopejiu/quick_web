...
[Section titled “Make an Element Draggable”](#make-an-element-draggable)
...
[Section titled “Define a Drop Zone”](#define-a-drop-zone)
...
[Section titled “Combining with File Drop”](#combining-with-file-drop)

If your app uses both HTML drag-and-drop and [File Drop](https://v3.wails.io/features/drag-and-drop/files), your HTML drop zones will also receive events when users drag files from the operating system. To prevent confusion, filter out file drags in your handlers:
...
[Section titled “Passing Data with dataTransfer”](#passing-data-with-datatransfer)
...
* [File Drop](https://v3.wails.io/features/drag-and-drop/files) \- Accept files from the operating system
* [MDN Drag and Drop API](https://developer.mozilla.org/en-US/docs/Web/API/HTML%5FDrag%5Fand%5FDrop%5FAPI) \- Full browser API reference
