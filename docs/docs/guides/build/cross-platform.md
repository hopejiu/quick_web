...
\*Linux ARM64 from Linux x86\_64 uses Docker because CGO cross-compilation requires a different toolchain.
...
* [Building Applications](https://v3.wails.io/guides/build/building) - Basic build commands and options
* [Signing Applications](https://v3.wails.io/guides/build/signing) - Code signing for distribution
