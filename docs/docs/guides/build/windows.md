...
> **Note:** MSIX requires either `makeappx.exe` (Windows SDK) or the standalone MSIX tooling. The Windows Taskfile exposes the install task as `wails3 task install:msix:tools`.
